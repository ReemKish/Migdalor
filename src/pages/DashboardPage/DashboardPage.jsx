...
const DashboardPage = () => {
  ...
  const filteredKeys = keys.filter(
    (k) => filter === "all" || k.room_type === filter,
  );
        ...
        <DialogContent>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2, pt: 2 }}>
            ...
            <TextField
              ...
              onChange={(e) =>
                setCheckoutForm({ ...checkoutForm, startTime: e.target.value })
              }
            ...
            <TextField
              ...
              onChange={(e) =>
                setCheckoutForm({ ...checkoutForm, endTime: e.target.value })
              }
              InputLabelProps={{ shrink: true }}
            />
          </Box>
        ...
        <DialogActions sx={{ p: 2, gap: 1 }}>
          ...
          <Button
            ...
            disabled={
              ...
              !checkoutForm.startTime ||
              !checkoutForm.endTime
            }
          >
            אישור
          </Button>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2, pt: 2 }}>
            <FormControl fullWidth>
              ...
              <Select
                ...
                onChange={(e) =>
                  setQueueForm({ ...queueForm, crew_name: e.target.value })
                }
                label="צוות/פלוגה"
              >
                <MenuItem value="" disabled>
            ...
            <TextField
              ...
              onChange={(e) =>
                setQueueForm({ ...queueForm, start_time: e.target.value })
              }
              InputLabelProps={{ shrink: true }}
            />
            ...
            <TextField
              ...
              onChange={(e) =>
                setQueueForm({ ...queueForm, end_time: e.target.value })
              }
              InputLabelProps={{ shrink: true }}
            />
            ...
            <FormControl fullWidth>
              ...
              <Select
                ...
                onChange={(e) =>
                  setQueueForm({ ...queueForm, preferred_type: e.target.value })
                }
                label="סוג חדר מועדף"
              >
